  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <script src="https://kit.fontawesome.com/3c7024af34.js" crossorigin="anonymous"></script>
      ...
      <main className={styles.main}>
        ...
        <section className={styles.grid} style={{padding: "8rem 0rem 8rem 0rem",background: "#E6FAF2"}}>
        <h2 className={styles.heading}>Answers you can trust.</h2>

          <div className={styles.gridlayout} >
            <p style={{fontSize: "1.2rem"}}>Find in-depth information about Next.js features and API.</p>
            <hr/>
            <div
              style={{width: '191.68px',height: '143.02px', background: '#93B8A4',
                borderRadius: '10px'}}
              ></div>
          </div>

          <div className={styles.gridlayout} style={{top: "-3rem", left: "-10rem"}}>
            <p style={{fontSize: "1.2rem"}}>Find in-depth information about Next.js features and API.</p>
            <hr/>
            <div
              style={{width: '191.68px',height: '143.02px', background: '#C4C4C4',
                borderRadius: '10px'}}
              ></div>
          </div>
